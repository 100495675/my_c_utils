...
Int main(void)
{
  ...
  Result(Void, cref(Char)) r1 = Vector_push_back(Int)(&first, 7);
  assert(Result_is_ok(Void, cref(Char))(&r1));
  Result_free(Void, cref(Char))(&r1);
  Result(Void, cref(Char)) r2 = Vector_push_back(Int)(&first, 8);
  ...
  Result(Void, cref(Char)) r3 = Vector_push_back(Int)(&second, 9);
  ...
  Result(Vector(Int), cref(Char)) popped = List_pop_back(Vector(Int))(&list);
  assert(Result_is_ok(Vector(Int), cref(Char))(&popped));
  Vector(Int) popped_vector = Result_unwrap(Vector(Int), cref(Char))(popped);
